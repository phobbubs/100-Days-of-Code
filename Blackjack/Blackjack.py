...
#initiate beginning of game    
user_draw_card()
user_draw_card()
com_draw_card()
com_draw_card()

#initiate while loop of gameplay
...
#exit while loop of gameplay, computer plays if score is less than 17
while com_score < 17:
    com_draw_card()
    com_score = sum(com_cards)

#calculate score and find winner    
